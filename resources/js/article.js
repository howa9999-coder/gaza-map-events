...
//                         <img src="images/articles/${article.image}" alt="${article.title}" class="w-full object-cover rounded-lg max-h-48 mb-4">
...
//                         </div>
//                         <a href="/single-article" class="read-button absolute bottom-4 right-4 text-blue-500 cursor-pointer p-0 bg-transparent border-none" data-title="${article.title}">
//                             Read
//                         </a>
//                     </div>`;
//       });
...
//           (article) =>
//             selectedValue === "All" || selectedValue === article.category
//         );
