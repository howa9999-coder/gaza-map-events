          ...
          <div class="card card-body border-0 shadow mb-4">
            ...
            <nav>
              <div class="nav nav-tabs mb-4" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active" id="ar-content-tab" data-bs-toggle="tab" href="#ar-content"
                  role="tab" aria-controls="ar-content" aria-selected="true">{{ __('arabic') }}</a>
                <a class="nav-item nav-link" id="en-content-tab" data-bs-toggle="tab" href="#en-content" role="tab"
                  aria-controls="en-content" aria-selected="false">{{ __('english') }}</a>
              </div>
            </nav>
              ...
              <div class="tab-pane fade show active" id="ar-content" role="tabpanel" aria-labelledby="ar-content-tab">
                <div class="mb-3">
                  ...
                  <input class="form-control @error('title') is-invalid @enderror" id="title" name="title"
                    type="text" value="{{ old('title') ?? $category->title }}"
            ...
            @else
              <div class="mb-3">
                ...
                <input class="form-control @error('order') is-invalid @enderror" id="order" name="order"
                  type="number" min="0" max="5" value="{{ old('order') ?? $category->order }}"
