    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item {{ \Request::route()->getName() == 'articles_manage' ? 'active' : '' }}">
        <a href="{{ route('articles_manage') }}" class="nav-link">
          <span class="sidebar-icon">
            <svg width="20.000000pt" height="20.000000pt" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
              style="padding-right: 6px;padding-left: 2px;box-sizing: border-box;fill: currentColor">
              <path
