      ...
      <div class="flex flex-wrap flex-row lg:justify-between -mx-3">
        <div class="flex-shrink max-w-full w-full lg:w-2/5 px-3 lg:pr-16">
          <div class="flex items-center mb-2">
            <span class="text-3xl leading-normal mb-2 font-bold text-gray-100 mt-2">GazaEvents</span>
            <!-- <img src="src/img-min/logo.png" alt="LOGO"> -->
          </div>
          <p>GazaEvents is a web app that provides real-time insights into the ongoing war in Gaza through an
            interactive map and detailed articles. It highlights key events, affected areas, and developments to
            keep
            you informed with accurate and up-to-date information.</p>
